...
| Help | Documentation | working | Opens repository documentation when available and reports missing/unreadable files through Logs without crashing. | Installed packaging may need to bundle documentation explicitly. |
| Plugins | Developer documentation | working | Opens the Plugin SDK when available and reports missing/unreadable files through Logs without crashing. | Installed packaging may need to bundle documentation explicitly. |
